...
export const metadata = {
  title: "Mauricien | Mariage | Directed by Qamar",
  description:
    "Galerie mariage — Mauricien. Une sélection d’images pour découvrir le style et la qualité du reportage.",
  alternates: { canonical: "/mariage/mauricien/" },
};
...
export default function MariageMauricienPage() {
  return (
