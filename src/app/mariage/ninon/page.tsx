...
export const metadata = {
  title: "Ninon | Mariage | Directed by Qamar",
  description:
    "Galerie mariage — Ninon. Une sélection d’images pour découvrir le style et la qualité du reportage.",
  alternates: { canonical: "/mariage/ninon/" },
};
...
export default function MariageNinonPage() {
  return (
